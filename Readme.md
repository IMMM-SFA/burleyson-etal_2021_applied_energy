...
| 2 | `Process_ComEd_Monthly_Total_Load_Profiles.m` | Script to process average weekday and weekend load profiles for all ComEd customers |
| 3 | `Process_ComEd_Monthly_Residential_Load_Profiles.m` | Script to process average weekday and weekend load profiles for residential ComEd customers |
| 4 | `Process_ComEd_Monthly_Non_Residential_Load_Profiles.m` | Script to process average weekday and weekend load profiles for non-residential ComEd customers |
